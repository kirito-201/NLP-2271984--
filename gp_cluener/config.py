...
common = {
    "exp_name": "cluener",
    "encoder": "BERT",
    "data_home": "gp_cluener/datasets",
    "bert_path": "gp_cluener/pretrained_models",  # bert-base-cased， bert-base-chinese
...
eval_config = {
    "model_state_dir": "gp_cluener/outputs/cluener/2022-04-15_08.04.41",  # 预测时注意填写模型路径（时间tag文件夹）
    "run_id": "",
    "last_k_model": 1,  # 取倒数第几个model_state
    "test_data": "test.json",
    "ent2id": "ent2id.json",
    "save_res_dir": "gp_cluener/results",
    "hyper_parameters": {
        "batch_size": 16,
        "max_seq_len": 512,
    }
