...
import torch
import json
from .config import eval_config,cawr_scheduler,step_scheduler
...
def data_generator(test_data,data_type="test"):
    """
    读取数据，生成DataLoader。
    """
...
# def evalclue(test_data):
#     test_dataloader = data_generator(test_data,data_type="test")
#
#     model = load_model()
#
...
def evalclue(test_data):
    ...
    #         f.write(json.dumps(item, ensure_ascii=False) + "\n")
    # print(test)
    # print(尼日利亚海军发言人当天在阿布贾向尼日利亚通讯社证实了这一消息)
    return predict_res
